...
type Repository interface {
	...
	GetTask(ctx context.Context, id int) (GetTaskStruct, error)
}
...
func (r *repository) GetTask(ctx context.Context, id int) (GetTaskStruct, error) {
	...
	if err != nil {
		return GetTaskStruct{}, errors.Wrap(err, "failed to get task")
	}
	return task, nil
}
