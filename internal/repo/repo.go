...
type Repository interface {
	...
	GetTaskByID(ctx context.Context, id int) (*TaskResponse, error)
}
...
// GetTaskByID - получение задачи из таблицы
func (r *repository) GetTaskByID(ctx context.Context, id int) (*TaskResponse, error) {
